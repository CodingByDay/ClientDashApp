    ...
    public partial class Dashboard : MaterialForm
    {
        ...
        private void Login()
        {
            ...
            while (count > 0)
            {
                ...
                {
                    MaterialSingleLineTextField uname = (MaterialSingleLineTextField)login.Controls["uname"];
                    MaterialSingleLineTextField pwd = (MaterialSingleLineTextField)login.Controls["pwd"];
        ...
        private bool CanLogin(MaterialSingleLineTextField uname, MaterialSingleLineTextField pwd)
        {
